...
always @* begin
    ...
    pal_cs      = !BUSn && A[23:12] == 12'b0100_0000_0000;
    vram_cs     = !BUSn && A[23:12] == 12'b1000_0000_0000;
    vregs_cs    = !BUSn && A[23:13] == 11'b1001_0000_000;
    io_cs       = !BUSn && A[23:4]  == 20'hC0000;
    sndlatch_cs = !BUSn && A[23:2]  == 22'h300004 && !RnW;
    wram_cs     = !BUSn && A[23:17] == 7'b0000001;
