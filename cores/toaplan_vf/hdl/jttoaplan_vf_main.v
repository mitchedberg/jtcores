...
always @* begin
    ...
    pal_cs      = !BUSn && A[23:12] == 12'b0100_0000_0000;  // 0x400000-0x400FFF (palette)
    vram_we     = !BUSn && A[23:12] == 12'b1000_0000_0000;  // 0x800000-0x800FFF (VRAM stub)
    io_cs       = !BUSn && A[23:4]  == 20'h20001;  // 0x200010-0x20001F (I/O)
    sndlatch_cs = !BUSn && A[23:1]  == 23'b0010_0000_0000_0000_0010_00 && !RnW;
    ram_cs      = !BUSn && A[23:17] == 7'b0000001;  // 0x100000-0x103FFF (Work RAM 16KB)
