...
// Splash: Z80 @ 3.75 MHz + YM3812 + MSM5205 ADPCM

module jtgaelco_splash_snd(
    input             rst,
    input             clk,
...
// --- Clock enable: 48 MHz / 13 = 3.69 MHz (close to 3.75 MHz) ---
reg [3:0] cen_cnt;
reg       cen_snd;
...
// --- I/O decode ---
always @(*) begin
    ym_cs     = !iorq_n && (!rd_n || !wr_n) && A[7:0] == 8'h00;
    latch_rd  = !iorq_n && !rd_n  && A[7:0] == 8'h01;
    latch_ack = !iorq_n && !wr_n  && A[7:0] == 8'h01;
end
