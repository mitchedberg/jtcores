...
// Taito Othunder Z80 + YM2610 sound module
// Z80 @ 8 MHz, clock enable generated from 48 MHz system clock

module jttaito_othunder_snd(
    input             rst,
    input             clk,
    ...
    input      [ 7:0] snd_data,
    input             snd_ok,
    // GFX ROM (SDRAM) - used for samples in Othunder
...
// GFX ROM for samples (stub - not fully wired yet)
