...
module jtdeco_cninja_main(
    ...
    input         [15:0] m2_dout,    // CPU-side vram2 read
    input         [15:0] m3_dout,    // CPU-side vram3 read
...
always @* begin
    ...
    vram0_cs    = !BUSn && A[23:17] == 7'b0010_110;  // 0x144000
    vram1_cs    = !BUSn && A[23:17] == 7'b0010_111;  // 0x146000
    vram2_cs    = !BUSn && A[23:17] == 7'b0010_101;  // 0x154000
    vram3_cs    = !BUSn && A[23:17] == 7'b0011_011;  // 0x156000
    pal_cs      = !BUSn && A[23:17] == 7'b1001_110;  // 0x19c000
    spr_cs      = !BUSn && A[23:17] == 7'b1010_010;  // 0x1a4000
...
initial begin
    rom_cs = 0; wram_cs = 0;
    pal_cs = 0; vram0_cs = 0; vram1_cs = 0; vram2_cs = 0; vram3_cs = 0; spr_cs = 0;
    snd_latch = 0;
    snd_stb = 0;
end
