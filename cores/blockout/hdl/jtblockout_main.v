...
always @* begin
    rom_cs      = !ASn  && A[23:18] == 6'b000000;  // 0x000000-0x03FFFF (ROM)
    pal_cs      = !BUSn && A[23:10] == 14'b0010_1000_0010_00;  // Palette
    io_cs       = !BUSn && A[23:4]  == 20'h10000;  // I/O space
    sndlatch_cs = !BUSn && A[23:2]  == 22'b0001_0000_0000_0001_01 && !RnW;  // Sound latch
    wram_cs     = !BUSn && A[23:17] == 7'b1111_110;  // Work RAM
