...
// Pixel clock: 48 MHz * 336 / 1024 = 15.75 MHz (pxl2_cen)
// pxl_cen = half of pxl2_cen = 7.875 MHz
...
jtframe_vtimer #(
    ...
    .VB_END     ( 9'd255          ),  // 256 total lines (0-255)
    .VS_START   ( 9'd248          ),  // vsync pulse
