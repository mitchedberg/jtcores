...
always @* begin
    ...
    pal_cs      = !BUSn && A[23:10] == 14'b0001_0100_0000_00;  // 0x140000-0x1405FF (palette)
    io_cs       = !BUSn && A[23:9]  == 15'b0001_0000_0000_000;  // 0x100000-0x1001FF (I/O)
    sndlatch_cs = !BUSn && A[23:1]  == 23'b0001_0100_0000_0001_0000_00 && !RnW;  // sound write
    ram_cs      = !BUSn && A[23:17] == 7'b1111_110;  // 0x1C0000-0x1C3FFF (Work RAM)
