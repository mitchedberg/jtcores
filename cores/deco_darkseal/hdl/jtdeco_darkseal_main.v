...
always @* begin
    ...
    vram0_cs    = !BUSn && A[23:17] == 7'b0010_000;  // 0x100000
    spr_cs      = !BUSn && A[23:17] == 7'b0010_010;  // 0x120000
    pal_cs      = !BUSn && A[23:17] == 7'b0010_100;  // 0x140000
    vram1_cs    = !BUSn && A[23:17] == 7'b0100_000;  // 0x200000
...
initial begin
    rom_cs = 0; wram_cs = 0;
    pal_cs = 0; vram0_cs = 0; vram1_cs = 0; spr_cs = 0;
    snd_latch = 0;
    snd_stb = 0;
end
