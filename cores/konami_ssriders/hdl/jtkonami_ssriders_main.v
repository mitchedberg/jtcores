...
// Konami Sunset Riders 68000 main CPU module

module jtkonami_ssriders_main(
    input                rst,
    input                clk,
    input                LVBL,
...
always @* begin
    ...
    spr_cs      = !BUSn && A[23:16] == 8'h10;
    pal_cs      = !BUSn && A[23:16] == 8'h20;
    vram0_cs    = !BUSn && A[23:16] == 8'h30;
    vram1_cs    = !BUSn && A[23:16] == 8'h40;
    vregs_cs    = !BUSn && A[23:16] == 8'h50;
    io_cs       = !BUSn && A[23:16] == 8'h60;
end
