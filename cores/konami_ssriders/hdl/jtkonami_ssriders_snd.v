...
// Konami Sunset Riders Z80 + YM2151 + K054539 sound module

module jtkonami_ssriders_snd(
    input             rst,
    input             clk,
...
// --- Chip-select signals ---
reg  macc_n;
reg  rom_cs, ram_cs, k054539_cs, ym2151_cs;
...
always @(*) begin
    ...
    ym2151_cs   = ~iorq_n && !rfsh_n && A[7:0] >= 8'h10 && A[7:0] < 8'h14;
