...
// Address decode — combinational (placeholder — adjust per hardware)
always @* begin
    rom_cs      = !ASn  && A[23:20] == 4'h0;
    spr_cs      = !BUSn && A[23:13] == 11'b0100_0000_000;
    pal_cs      = !BUSn && A[23:13] == 11'b0110_0000_000;
    vram0_cs    = !BUSn && A[23:13] == 11'b1000_0000_000;
    vram1_cs    = !BUSn && A[23:13] == 11'b1000_0000_001;
...
// CPU clock enable (TODO: verify num/den for target hardware)
...
initial begin
    rom_cs = 0; wram_cs = 0;
    spr_cs = 0; pal_cs = 0;
    vram0_cs = 0; vram1_cs = 0; vregs_cs = 0;
    snd_latch = 0;
    snd_stb = 0;
end
