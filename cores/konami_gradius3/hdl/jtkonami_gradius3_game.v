...
assign vram1_we = work_cs   ? bram_we : 2'b00;
...
// Unused SDRAM buses
assign tile_cs_sdram     = 0;
assign tile_addr   = 0;
assign obj_cs      = 0;
assign obj_addr    = 0;

`ifndef NOMAIN
jtkonami_gradius3_main u_main(
    .rst        ( rst           ),
    .clk        ( clk           ),
    .LVBL       ( LVBL          ),
