...
module jtseibu_cop_main(
    ...
    input         [15:0] mo_dout,    // CPU-side obj read
...
always @* begin
    ...
    vram_cs     = !BUSn && A[23:17] == 7'b0010_100;  // 0x140000
    obj_cs      = !BUSn && A[23:17] == 7'b0011_000;  // 0x160000
